...
function ModalEdit({ openModalEdit, typeEdit, handleCloseEdit, idEdit, style, fetchAPI, setVarRefeshPage, varRefeshPage, rowClicked }) {
    ...
    const onBtnUpdateClick = () => {
        ...
        if (vCheckData) {
            ...
            fetchAPI('http://localhost:8000/product/' + idEdit, body)
                .then((data) => {
                    console.log(data);
                    setOpenAlert(true);
                    setNoidungAlertValid("Update Product thành công!")
                ...
                .catch((error) => {
                    console.log(error);
                    setOpenAlert(true);
                    setNoidungAlertValid("Update Product thất bại!")
                    ...
                    <Grid container className="mt-4 text-center">
                        <Grid item sm={12}>
                            <Grid container className="mt-4">
                                <Grid item sm={6}>
                                    <Button onClick={onBtnUpdateClick} className="bg-success w-75 text-white">Edit Product</Button>
                                </Grid>
                                <Grid item sm={6}>
