...
function ModalDelete({ openModalDelete, idDelete, nameDelete ,handleCloseDelete, style, setVarRefeshPage, varRefeshPage }) {
    ...
    const onBtnConfirmDeleteClick = () => {
        ...
        fetch("http://localhost:8000/product/" + idDelete, { method: 'DELETE' })
            // .then(async response => {
            ...
            .then((data) => {
                ...
                setNoidungAlert("Xóa Sản Phẩm " + nameDelete + " thành công!")
            ...
            .catch(error => {
                ...
                setNoidungAlert("Xóa Sản Phẩm " + { nameDelete } + " thất bại!")
                handleCloseDelete()
            });
    }
