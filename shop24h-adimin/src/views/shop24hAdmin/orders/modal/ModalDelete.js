...
function ModalDelete({ openModalDelete, orderIdDelete, nameDelete, customerIdDelete, handleCloseDelete, setVarRefeshPage, varRefeshPage }) {
    ...
    const onBtnConfirmDeleteClick = () => {
        ...
        fetch(`http://localhost:8000/customers/${customerIdDelete}/orders/${orderIdDelete}`, { method: 'DELETE' })
            .then((data) => {
                console.log('Delete successful');
                setOpenAlert(true)
                setStatusModalEdit("success")
                setNoidungAlert("Xóa Order" + orderIdDelete + " thành công!")
            ...
            .catch(error => {
                ...
                setNoidungAlert("Xóa Order" + { orderIdDelete } + " thất bại!")
                handleCloseDelete()
            });
    }
                    ...
                    <Grid container className="mt-2">
                        <Grid item xs={12} align="center">
                            <Typography mb={2} variant="h5">
                                Bạn có thật sự muốn xóa Đơn hàng Của khách hàng :
